...
{{<figure src="./loosen.jpg">}}

{{<figure src="./pulloutfree.jpg">}}

フリーボディは引っ張ればスポっと抜ける。作業のために一旦掃除したが、シャフトを回しているとみるみるうちに墨汁が滲んでくる。

{{<figure src="./dirty.jpg">}}
...
{{<figure src="./6903_lbuu.jpg">}}
{{<figure src="./crash.jpg">}}

片方のベアリングが粉々？になっていた。

{{<figure src="./xero_bearing.jpg">}}
