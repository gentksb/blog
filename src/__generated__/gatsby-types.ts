...
type AllPostNodeQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly fields: Maybe<Pick<MdxFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'title'>> } }> } };
