...
大まかに言うと、Blue Lugブースで**ミッションを受け、ミッションシートに書かれているコース内のスポットを回りサインをもらったりデリバリーをしたりして、完了したらBlue Lugブースに戻りポイントを手に入れる**という仕組みのようだ。

規定時間内の累積ポイントで順位が決まる。**コースを街に見立てたメッセンジャーとしての能力を競うレース**のようだ。
